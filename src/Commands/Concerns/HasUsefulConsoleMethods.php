...
trait HasUsefulConsoleMethods
{
    ...
    {
        render("
        <div class='px-1 py-1 bg-red-500 text-gray-50 font-bold'>$message</div>
        ");
    ...
    {
        render('
            <a href="https://github.com/worksome/exchange" class="my-1 px-1 py-1 bg-blue-500 font-bold w-full text-center">
                ⭐️ If you like Exchange, show your support by starring the repository! ⭐️
            </a>
        ');
    }
}
